...
const {globalState, updateGlobalState} = useGlobalState() 
  ...
  var socketUrl = "http://localhost:4001"; // Socket URL
  let params = new URLSearchParams(window.location.search); // Get URL parameters
  var username = globalState.name; // Get the 'username' parameter from the URL
  var meeting_id = globalState.meetingId; // Get the 'meeting_id' parameter from the URL
