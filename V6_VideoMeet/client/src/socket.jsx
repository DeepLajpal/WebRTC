...
var username = params.get('username'); // Get the 'username' parameter from the URL
var meeting_id = params.get('meeting_id'); // Get the 'meeting_id' parameter from the URL
